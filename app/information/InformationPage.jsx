                ...
                <div className="prose prose-lg dark:prose-invert max-w-none">
                  ...
                  <div className="mt-12 p-8 bg-linear-to-br from-primary/5 to-primary/10 rounded-2xl border border-primary/20">
                    ...
                    <p className="text-muted-foreground leading-relaxed">
                      ...
                      transaction. It&apos;s about providing you with the
                      freedom to explore, the confidence to travel, and the
                      peace of mind to enjoy every moment of your journey.
                      That&apos;s the CariBara difference.
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center bg-linear-to-br from-zinc-100 to-zinc-200 dark:from-zinc-900 dark:to-zinc-800 rounded-2xl p-12">
              ...
              <p className="text-xl text-muted-foreground mb-8">
                Explore our full collection and find the perfect car for your
                next journey
              </p>
